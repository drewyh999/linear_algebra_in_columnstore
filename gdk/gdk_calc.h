...
gdk_export BAT *BATmatmul(long size_left, long size_right, BAT **left, BAT **right);
gdk_export BAT *BATtranspose(BAT *headers, BAT *ordering_schema_bat, BAT **application_schema_bats, int application_schema_count);
