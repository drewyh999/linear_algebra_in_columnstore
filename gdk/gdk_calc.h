...
gdk_export BAT *BATcalcmatmul(long size_left, long size_right, BAT **left, BAT **right);
gdk_export BAT *BATcalcmatsubtractvector(long size_left, long size_right, BAT **left, BAT **right);
gdk_export BAT *BATcalcmattranspose(BAT *headers, BAT *ordering_schema_bat, BAT **application_schema_bats, int application_schema_count);
gdk_export BAT *BATtransposeheader(BAT *ordering_schema_bat);
